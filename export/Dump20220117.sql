...
CREATE TABLE `aliment` (
  ...
  `carbohidrati` int NOT NULL,
  `grasimi` int NOT NULL,
  `grasimi_saturate` int DEFAULT NULL,
  `sodiu` int DEFAULT NULL,
  `zahar` int DEFAULT NULL,
...
INSERT INTO `aliment` VALUES (1,'mar verde','gram',52,1,14,1,0,0,10),(2,'portocala','gram',20,1,7,0,0,0,6),(3,'banana','gram',12,20,16,1,0,0,10),(4,'pui','pulpa superioara',109,13,0,6,0,0,0),(5,'pui','piept',165,31,0,4,0,0,0),(6,'tort ciocolata','felie',424,5,55,22,0,0,44),(7,'paine','felie',82,4,14,1,0,0,2),(8,'salam','100 grame',250,14,2,20,8,0,0),(9,'carnati','bucata',242,14,2,20,7,574,1),(10,'ceafa porc','100 grame',231,24,0,14,5,0,1),(11,'mango','bucata',201,3,50,1,0,3,46),(12,'kiwi','bucata',61,1,15,0,0,3,9),(13,'avocado','bucata',322,4,17,30,4,0,1),(14,'para','bucata',102,0,27,0,0,2,17),(15,'hamburger','bucata',354,20,29,17,6,496,5),(16,'spaghetti','100 grame',158,6,31,1,0,1,1),(17,'pizza','intreaga',2269,97,284,83,38,5101,31),(18,'iaurt','1 cutie',59,10,4,0,0,36,3),(19,'cola','sticla',184,0,47,0,0,20,44),(20,'sprite','sticla mica',194,0,50,0,0,5,44),(21,'ou','ou intreg',155,13,1,11,3,124,1),(22,'bacon','bucata',541,37,1,42,14,1717,0),(23,'galbenus','1 bucata',322,16,4,27,10,48,0),(24,'albus','1 bucata',52,11,1,0,0,166,1),(25,'tortilla','100 grame',218,6,45,3,1,45,NULL),(26,'mamaliga','100 grame',370,7,79,2,0,7,2),(27,'raviolli','100 grame',77,3,14,2,1,306,4),(28,'linguini','100 grame',213,8,42,1,0,NULL,NULL),(29,'canneloni','100 grame',190,11,32,2,1,NULL,NULL),(30,'branza','100 grame',402,25,1,33,21,621,1);
/*!40000 ALTER TABLE `aliment` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `aliment_dieta`
--

DROP TABLE IF EXISTS `aliment_dieta`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `aliment_dieta` (
  `data_introducere` date NOT NULL,
  `dieta_id` int NOT NULL,
  `aliment_id` int NOT NULL,
  `cantitate` int NOT NULL,
  PRIMARY KEY (`data_introducere`,`dieta_id`,`aliment_id`),
  KEY `dieta_id` (`dieta_id`),
  KEY `aliment_id` (`aliment_id`),
  CONSTRAINT `aliment_dieta_ibfk_1` FOREIGN KEY (`dieta_id`) REFERENCES `dieta` (`dieta_id`) ON DELETE CASCADE,
  CONSTRAINT `aliment_dieta_ibfk_2` FOREIGN KEY (`aliment_id`) REFERENCES `aliment` (`aliment_id`) ON DELETE CASCADE,
  CONSTRAINT `cantitate` CHECK ((`cantitate` > 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `aliment_dieta`
--

LOCK TABLES `aliment_dieta` WRITE;
/*!40000 ALTER TABLE `aliment_dieta` DISABLE KEYS */;
INSERT INTO `aliment_dieta` VALUES ('2017-11-12',4,17,3),('2018-04-22',7,27,2),('2019-01-12',1,5,2),('2019-01-12',1,7,3),('2019-01-12',3,5,1),('2019-01-12',5,12,2),('2019-01-12',6,1,200),('2019-11-12',2,11,3);
/*!40000 ALTER TABLE `aliment_dieta` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `antrenor`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `antrenor` (
  `antrenor_id` int NOT NULL,
  `antrenor_nume` varchar(255) NOT NULL,
  `antrenor_parola` varchar(255) NOT NULL,
  `validare` int NOT NULL,
  `specializare` varchar(255) NOT NULL,
  PRIMARY KEY (`antrenor_id`),
  CONSTRAINT `specializare` CHECK (((`specializare` = _utf8mb4'inot') or (`specializare` = _utf8mb4'forta'))),
  CONSTRAINT `validare` CHECK (((`validare` >= 0) and (`validare` < 2)))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `antrenor` WRITE;
/*!40000 ALTER TABLE `antrenor` DISABLE KEYS */;
INSERT INTO `antrenor` VALUES (1,'adi','12345',0,'inot'),(2,'bebino','54321',1,'forta'),(3,'gary','12345',0,'forta'),(4,'florian','594321',0,'forta'),(5,'diana','123845',1,'inot'),(6,'dacian','54321',1,'inot'),(7,'yoshi','332017',0,'inot'),(8,'chiriac','5439921',1,'forta'),(9,'newman','1977',0,'inot'),(10,'orwell george','1984',1,'inot'),(11,'alin zlotea','12345',0,'forta'),(12,'neagu marian','4234',1,'forta'),(13,'ali alexandru','89345',1,'forta'),(14,'mari petrea','784621',0,'inot'),(15,'dani daniel','12342',1,'inot'),(16,'radulescu alex','6r4re',1,'forta'),(17,'alexandrescu alin','6783asdf',1,'inot'),(18,'Andy Warhol','6546421',0,'forta'),(19,'Lenghel Ionut','346hfs',1,'forta'),(20,'Anghel Razvan','674dfs',1,'inot'),(21,'Carina Ericson','561sdf',1,'inot'),(22,'Charles Ruben','rtdefs',0,'forta'),(23,'Robert Smith','rtfd',0,'inot'),(24,'Andrei Tara','456sa',1,'forta'),(25,'Stefan Cherescu','45fsdzx',1,'forta'),(26,'Lanvin Alice','123das',0,'inot'),(27,'Prada Miucci','124rasz',0,'forta'),(28,'Kiko Kostadinov','yrtfgdcx',1,'inot'),(29,'Mathew Williams','65rtedfs',0,'inot'),(30,'Junya Watanabe','43wt342',1,'forta');
/*!40000 ALTER TABLE `antrenor` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `asignare_produs`
--

DROP TABLE IF EXISTS `asignare_produs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `asignare_produs` (
  `data_asignare` date NOT NULL,
  `client_id` int NOT NULL,
  `produs_id` int NOT NULL,
  PRIMARY KEY (`data_asignare`,`client_id`,`produs_id`),
  KEY `FK_asignare_produs` (`client_id`),
  KEY `FK_asignare_produs_2` (`produs_id`),
  CONSTRAINT `FK_asignare_produs` FOREIGN KEY (`client_id`) REFERENCES `client` (`client_id`) ON DELETE CASCADE,
  CONSTRAINT `FK_asignare_produs_2` FOREIGN KEY (`produs_id`) REFERENCES `produs` (`produs_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `asignare_produs`
--

LOCK TABLES `asignare_produs` WRITE;
/*!40000 ALTER TABLE `asignare_produs` DISABLE KEYS */;
INSERT INTO `asignare_produs` VALUES ('2017-01-15',1,1),('2019-06-20',1,3),('2017-01-15',2,2),('2019-03-12',6,3),('2019-08-22',9,2),('2019-08-22',19,1),('2020-08-22',21,3);
/*!40000 ALTER TABLE `asignare_produs` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `client` (
  ...
  `client_parola` varchar(255) NOT NULL,
  `greutate` int NOT NULL,
  `varsta` int DEFAULT NULL,
  `adresa` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`client_id`),
  CONSTRAINT `greutate` CHECK ((`greutate` > 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `client` VALUES (1,'dragos andrei','12345',50,NULL,NULL),(2,'raul enciu','123445',60,12,'Ramnicu Valcea Strada Rozelor 1'),(3,'luca sandu','12333',23,11,'strada berceni'),(4,'mc gyuszi','11233',33,13,'strada dafodila'),(5,'big moe','11231233',244,11,'strada narcis'),(6,'dj paul','133333',100,45,'strada berca'),(7,'robert coman','1112333',77,27,'strada ovidiu'),(8,'money jordan','2333',30,85,'strada miami'),(9,'black kray','232323',45,27,'strada florida'),(10,'marian dragos','15523',90,26,'strada zorilor'),(11,'real southplaya','111333',70,44,'strada canada'),(12,'koopsta knicca','888777',72,30,'strada alex'),(13,'milan sc','5675675',64,NULL,'strada berceni'),(15,'Ciprian Arde','161616',66,90,'strada alyx'),(16,'marcy mane','5432312',83,43,'strada flexico'),(17,'don pico','111333',23,11,'strada purrp'),(18,'liu kang','435345',53,74,'strada mk 4'),(19,'yoshi mitsu','1546754',66,33,'strada tekken 7'),(20,'Quan Chi','666444',85,72,'strada chi quan'),(21,'Herme$ DaGod','23242342',90,13,'strada bmb 2020'),(22,'majin badiu','2132342',70,55,'strada simbol 11'),(23,'jordan carter','1756756',65,22,'strada wave 15'),(24,'bumbu mari','67834',88,49,'strada arthur 22'),(25,'ion luca','8234',66,25,'strada eminescu'),(27,'john lennon','12333',100,75,'strada mullholand'),(28,'david lynch','4949',63,22,'strada ben ben'),(29,'laura palmer','20202',47,20,'strada twin peaks 27'),(30,'dale cooper','5432423',85,33,'strada yellow road');
...
CREATE TABLE `contract` (
  ...
  `antrenor_id` int NOT NULL,
  `client_id` int NOT NULL,
  `suma_bani` int NOT NULL,
  PRIMARY KEY (`data_inceput`,`antrenor_id`,`client_id`),
  KEY `antrenor_id` (`antrenor_id`),
  KEY `client_id` (`client_id`),
  CONSTRAINT `contract_ibfk_1` FOREIGN KEY (`antrenor_id`) REFERENCES `antrenor` (`antrenor_id`) ON DELETE CASCADE,
  CONSTRAINT `contract_ibfk_2` FOREIGN KEY (`client_id`) REFERENCES `client` (`client_id`) ON DELETE CASCADE,
  CONSTRAINT `bani` CHECK ((`suma_bani` > 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `contract` VALUES ('2016-03-01','2016-08-22',16,7,500),('2017-06-15','2017-12-15',2,1,500),('2017-06-15','2017-12-15',5,2,500),('2017-06-15','2017-12-15',30,7,500),('2017-10-05','2017-10-21',13,5,500),('2018-06-11','2018-12-28',28,15,500),('2019-01-08','2019-02-15',16,10,500),('2019-04-02','2020-07-07',12,12,500),('2019-10-05','2020-01-02',20,16,500),('2021-02-07','2021-08-27',28,23,500);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trigger_contract` BEFORE INSERT ON `contract` FOR EACH ROW BEGIN
      if exists(select * from antrenor where antrenor_id = new.antrenor_id and validare = 0)	
        THEN  signal sqlstate '45000' set message_text = 'nu este antrenor acreditat';
    END if;
END */;;
DELIMITER ;
...
CREATE TABLE `dieta` (
  ...
  `tip_autor` varchar(255) DEFAULT NULL,
  `autor_id` int DEFAULT NULL,
  PRIMARY KEY (`dieta_id`),
  CONSTRAINT `dieta_chk_1` CHECK (((`tip_autor` = _utf8mb4'antrenor') or (`tip_autor` = _utf8mb4'client')))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `dieta` VALUES (1,'2021-05-16',NULL,'client',1),(2,'2021-03-20','2022-01-17','client',2),(3,'2020-04-12','2021-05-03','antrenor',25),(4,'2020-04-12','2021-05-03','antrenor',2),(5,'2017-06-15','2017-12-15','antrenor',5),(6,'2017-06-15','2017-12-15','client',17),(7,'2017-06-15','2017-12-15','client',17);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trigger_dieta` BEFORE INSERT ON `dieta` FOR EACH ROW BEGIN
      if (new.tip_autor = 'antrenor' and not exists(select * from contract where antrenor_id = new.autor_id))	
        THEN  signal sqlstate '45000' set message_text = 'autorul este antrenor neacreditat';
    END if;
...
--
-- Table structure for table `exercitiu`
--

DROP TABLE IF EXISTS `exercitiu`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `exercitiu` (
  `exercitiu_id` int NOT NULL,
  `nume_exercitiu` varchar(255) NOT NULL,
  `grupa_musculara` varchar(255) NOT NULL,
  `nr_repetari` int NOT NULL,
  PRIMARY KEY (`exercitiu_id`),
  CONSTRAINT `repetari` CHECK ((`nr_repetari` >= 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `exercitiu`
--

LOCK TABLES `exercitiu` WRITE;
/*!40000 ALTER TABLE `exercitiu` DISABLE KEYS */;
INSERT INTO `exercitiu` VALUES (1,'tractiuni','latissimus',10),(2,'flotari','piept',20),(3,'tractiuni','latissimus',8),(4,'flotari','piept',15),(5,'military press','deltoizi',10),(6,'military press','deltoizi',5),(7,'bench press','piept',12),(8,'bench press','piept',8),(9,'triceps pushdown','triceps',5),(10,'triceps pushdown','triceps',10),(11,'biceps curls','biceps',10),(12,'biceps curls','biceps',5),(13,'genoflexiuni','picioare',15),(14,'genoflexiuni','picioare',8),(15,'inot crawl','cardio',10);
/*!40000 ALTER TABLE `exercitiu` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `exercitiu_program`
--

DROP TABLE IF EXISTS `exercitiu_program`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `exercitiu_program` (
  `data_adaugare` date NOT NULL,
  `exercitiu_id` int NOT NULL,
  `program_id` int NOT NULL,
  `nr_seturi` int NOT NULL,
  `pauza_seturi` varchar(255) NOT NULL,
  PRIMARY KEY (`data_adaugare`,`exercitiu_id`,`program_id`),
  KEY `exercitiu_id` (`exercitiu_id`),
  KEY `program_id` (`program_id`),
  CONSTRAINT `exercitiu_program_ibfk_1` FOREIGN KEY (`exercitiu_id`) REFERENCES `exercitiu` (`exercitiu_id`) ON DELETE CASCADE,
  CONSTRAINT `exercitiu_program_ibfk_2` FOREIGN KEY (`program_id`) REFERENCES `program` (`program_id`) ON DELETE CASCADE,
  CONSTRAINT `exercitiu_program_chk_1` CHECK (((`nr_seturi` > 0) and regexp_like(`pauza_seturi`,_utf8mb4'^[0-9] minute')))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `exercitiu_program`
--

LOCK TABLES `exercitiu_program` WRITE;
/*!40000 ALTER TABLE `exercitiu_program` DISABLE KEYS */;
INSERT INTO `exercitiu_program` VALUES ('2018-04-22',1,2,3,'1 minute'),('2018-04-22',4,1,5,'1 minute'),('2018-04-22',9,3,4,'2 minute'),('2018-04-22',13,5,5,'2 minute'),('2018-04-22',15,4,6,'1 minute');
/*!40000 ALTER TABLE `exercitiu_program` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `produs` (
  ...
  CONSTRAINT `greutatenenula` CHECK ((`greutate` > 0))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `produs` VALUES (1,'pudra proteina',1000),(2,'cana',50),(3,'tricou',500);
...
CREATE TABLE `program` (
  ...
  `target_calorii` int DEFAULT NULL,
  `target_proteine` int DEFAULT NULL,
  `target_carbohidrati` int DEFAULT NULL,
  `target_grasimi` int DEFAULT NULL,
  `tip_autor` varchar(255) DEFAULT NULL,
  `autor_id` int NOT NULL,
  `client_id` int DEFAULT NULL,
  `dieta_id` int NOT NULL,
  PRIMARY KEY (`program_id`),
  UNIQUE KEY `target_calorii` (`target_calorii`,`dieta_id`),
  KEY `client_id` (`client_id`),
  CONSTRAINT `program_ibfk_1` FOREIGN KEY (`client_id`) REFERENCES `client` (`client_id`) ON DELETE CASCADE,
  CONSTRAINT `tip_autor` CHECK (((`tip_autor` = _utf8mb4'client') or (`tip_autor` = _utf8mb4'antrenor')))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `program` VALUES (1,'2017-06-15','2017-12-15',2700,160,300,80,'antrenor',5,2,1),(2,'2017-06-15','2017-12-15',3000,140,250,70,'antrenor',30,7,2),(3,'2017-06-15','2017-12-15',3000,140,250,70,'antrenor',28,15,3),(4,'2017-06-15','2017-12-15',3199,143,400,89,'antrenor',20,16,4),(5,'2017-06-15','2017-12-15',2345,167,324,95,'antrenor',12,12,5),(6,'2016-03-01','2016-08-22',3455,132,456,76,'antrenor',16,7,6),(7,'2017-06-15','2017-12-15',3452,143,342,87,'client',17,17,7);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trigger_program` BEFORE INSERT ON `program` FOR EACH ROW BEGIN
      if (new.tip_autor = 'antrenor' and not exists(select * from contract where antrenor_id = new.autor_id))	
        THEN  signal sqlstate '45000' set message_text = 'autorul este antrenor neacreditat';
    END if;
    if (new.tip_autor = 'antrenor' and not exists(select * from contract where antrenor_id = new.autor_id and client_id = new.client_id))
		then signal sqlstate '45000' set message_text = 'acest antrenor nu antreneaza acest client';
	end if;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2022-01-12 19:15:08',NULL),('diagnostics.include_raw','OFF','2022-01-12 19:15:08',NULL),('ps_thread_trx_info.max_length','65535','2022-01-12 19:15:08',NULL),('statement_performance_analyzer.limit','100','2022-01-12 19:15:08',NULL),('statement_performance_analyzer.view',NULL,'2022-01-12 19:15:08',NULL),('statement_truncate_len','64','2022-01-12 19:15:08',NULL);
...
-- Dump completed on 2022-01-17 23:56:39
